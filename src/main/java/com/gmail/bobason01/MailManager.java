...
import com.gmail.bobason01.utils.ChatListener; // 추가
import com.gmail.bobason01.utils.ChatSearchRegistry; // 추가
...
public final class MailManager extends JavaPlugin {
    ...
    // 추가: 가상 인벤토리 GUI
    public MailInventoryGUI mailInventoryGUI;
    ...
    public void onEnable() {
        ...
        // 가상 인벤토리 GUI 초기화 (id는 호출 시 결정되므로 대표 리스너로 0번 사용 가능하나, 구조상 리스너 등록용)
        mailInventoryGUI = new MailInventoryGUI(0, false);
